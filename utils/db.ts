...
import type { SalesMemoImage, Product, SaleInvoice, PurchaseInvoice, Customer, Supplier, Employee, Expense, Service, StoreSettings, CustomerTransaction, SupplierTransaction, PayrollTransaction, ActivityLog, User, Role } from '../types';

const DB_NAME = 'KetabestanLocalDB';
const DB_VERSION = 3; // ارتقای ورژن برای اضافه شدن استورهای جدید
